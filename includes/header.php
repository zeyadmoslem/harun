                ...
                <div class="container">
                    <div class="">
                        ...
                        <div class="navbar-header">
                            <button type="button" class="navbar-toggle navbar-toggle-dark collapsed"
                            ...
                            <a class="logo" href="index.html">
                                <img style="height: 75px ;" class="logo-light" src="assets/images/logo/Logo.png"
                                    alt="granny Logo">
                                <img style="height: 75px ;" class="logo-dark" src="assets/images/logo/Logo.png"
                                    alt="granny Logo">
                            </a>
                        </div>
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2">
                                                    <form class="form-search">
                                                        <input type="text" class="form-control"
                                                            placeholder="Geben Sie Suchbegriffe ein !">
    ...
    ============================================= -->
                        ...
                        <div class="collapse navbar-collapse pull-right" id="navbar-collapse-1">
                            <ul class="nav navbar-nav nav-pos-right navbar-left">
                                <!-- Home Menu -->
                                <li>
                                    <a class="menu-item" href="https://harun.test">Startseite</a>
                                </li>
                                <!-- li end -->

                                <!-- Menü Menu -->
                                <li>
                                    <a class="menu-item" href="#">Menü</a>
                                </li>
                                <!-- li end -->

                                <!-- Impressum Menu -->
                                <li>
                                    <a class="menu-item" href="/imprint.php">Impressum</a>
                                </li>
                                <!-- li end -->
                                <!-- Datenschütz Menu -->
                                <li>
                                    <a class="menu-item" href="#">Datenschütz</a>
                                </li>
                                <!-- li end -->
                                <!-- Datenschütz Menu -->
                                <li>
                                   <!--  <a style="--clr:#ffc107" class=" menu-item"
                                        href="http://localhost/projects/zeyad_resume/portfolio.php"><span
                                            class="c-btn"><span class="con">Explore now</span><i></i></span></a> -->
                                            <a class="menu-item" href="/contact.php">Kontakt</a>
