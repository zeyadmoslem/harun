                ...
                <div id="slider1" class="rev_slider" data-version="5.0">
                    <ul>
                        ...
                        <li data-transition="slotfade-vertical" data-slotamount="default" data-masterspeed="0">
                            <!-- MAIN IMAGE -->
                            <img src="assets/images/sliders/slide-bg/ss.avif" alt="Slide Background Image" width="1920"
                                height="1280">
                            <!-- LAYER NR. 1 -->
                            <div class="tp-caption" data-x="center" data-hoffset="0" data-y="center" data-voffset="-150"
                                ...
                                <div class="slide--icon"><img src="assets/images/sliders/slide-bg/fork-img.png"
                                        alt="fork img"></div>
                            </div>
                            <!-- LAYER NR. 1 -->
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="banner-panel">
                            <div class="banner--img">
                                <img src="assets/images/banners/1.jpg" alt="banner img" class="img-responsive">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="banner-panel">
                            <div class="banner--img">
                                <img src="assets/images/banners/5.jpg" alt="banner img" class="img-responsive">
        ...
        <section id="menuGrid" class="bg-dark">
            ...
            <div class="container pr-0 pl-0 tabs">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-6 pr-0 pl-0 d-none d-md-block" style="height:550px ;">
                                                <div class="bg-overlay bg-overlay-dark">
                                                    <div class="bg-section">
                                                        <img src="assets/images/menu/split/1.jpg" alt="Background" />
                                                    </div>
                ...
                <div class="row text-center mt-70">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <a class="btn btn--secondary btn--lg" href="#">Vollständige Menü</a>
                    </div>
                </div>
                <!-- .row end -->
            </div>
                            ...
                            <form method="post" action="assets/php/reservation.php" class="reservationForm mb-0">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-6">
                                        <input type="text" class="form-control" name="res-name" id="name"
                                            placeholder="Name*" required>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-6">
                                        <input type="email" class="form-control" name="res-email" id="email"
                                            placeholder="E-Mail Adresse*" required>
                                    </div>
                                    <div class="col-xs-12 ">
                                        <input type="text" class="form-control" name="res-subject" id="subject"
                                            placeholder="Betreff*" required>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <textarea class="form-control" name="res-message" id="message" rows="2"
                            ...
                            <div class="testimonial-panel">
                                ...
                                <div class="testimonial--meta">
                                    <div class="testimonial--img">
                                        <img src="assets/images/testimonial/1.jpg" alt="Zeyad">
                                    </div>
